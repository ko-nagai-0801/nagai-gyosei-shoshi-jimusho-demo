    ...
    <>
      ...
      <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <article className="section-card p-6 sm:p-8">
          <h2 className="font-serif text-3xl text-[var(--base)]">事務所概要</h2>
        ...
        <aside className="section-card p-6 sm:p-8">
          <h2 className="font-serif text-2xl text-[var(--base)]">主な対応業務</h2>
      ...
      <section className="space-y-6">
        <div className="space-y-2">
          ...
          <h2 className="font-serif text-3xl text-[var(--base)]">料金案内（目安）</h2>
        </div>
        <div className="grid gap-4 md:grid-cols-3">
          {feeGuides.map((guide) => (
            <article key={guide.item} className="section-card p-6">
              ...
              <h3 className="mt-2 font-serif text-xl text-[var(--base)]">{guide.fee}</h3>
      ...
      <section className="space-y-6">
        <h2 className="font-serif text-3xl text-[var(--base)]">事務所沿革</h2>
        <ol className="space-y-4">
          {timeline.map((item) => (
            ...
            >
              ...
              <div>
                <h3 className="font-serif text-xl text-[var(--base)]">{item.title}</h3>
